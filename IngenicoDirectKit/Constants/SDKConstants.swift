...
public class SDKConstants {
    ...
    public static let kSDKBundleIdentifier = "org.cocoapods.IngenicoDirectKit"
    public static var kSDKBundlePath = Bundle(identifier: SDKConstants.kSDKBundleIdentifier)?.path(forResource: "IngenicoDirectKit", ofType: "bundle")
